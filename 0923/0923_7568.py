...
# 여러분은 학생 N명의 몸무게와 키가 담긴입력을 읽어서 각 사람의 덩치 등수를 계산하여 출력해야 한다.

# 리스트로 순위 반환
def solution(nCount: int, lstData: list) -> list:
    pass


if __name__ == '__main__':
    n_count = int(input())
    # [(55, 180), (58, 183), (88, 186), (60, 175), (46, 155)]
    lst_data = [ tuple(map(int, input().split())) for _ in range(n_count)]

    print(lst_data)
    for i in solution(n_count, lst_data):
        print(i, end=' ')
